...
- Alkaloid & Saponin: hỗ trợ giải độc, tăng cường miễn dịch :contentReference[oaicite:0]{index=0}  
...
- Tăng cường sức đề kháng và chống oxy hóa :contentReference[oaicite:1]{index=1}  
...
export const membershipPackages: MembershipPackage[] = [
    {
        ...
        price: 15000,
        description: {
            vi: "Cho khách hàng mới trải nghiệm quyền lợi cơ bản trước khi mua gói cao hơn.",
            en: "A starter package for new customers to try core benefits before upgrading.",
            zh: "适合新客户在升级前体验基础会员权益。",
        },
        benefits: [
            { vi: "Voucher giảm 10% đơn hàng đầu tiên", en: "10% off first order voucher", zh: "首单 10% 优惠券" },
            { vi: "Tài liệu sức khỏe miễn phí", en: "Free health documents", zh: "免费健康资料" },
            { vi: "Newsletter chăm sóc sức khỏe", en: "Health care newsletter", zh: "健康护理通讯" },
            { vi: "Tra cứu nguồn gốc sản phẩm", en: "Product origin lookup", zh: "查询产品溯源信息" },
        ],
    ...
    },
    {
        ...
        price: 299000,
        description: {
            vi: "Dành cho khách hàng cá nhân muốn sử dụng sản phẩm và được tư vấn online cơ bản.",
            en: "For individual customers who want products plus basic online consultation.",
            zh: "适合希望购买产品并获得基础在线咨询的个人客户。",
        },
        benefits: [
            { vi: "Combo 3 loại trà thảo dược", en: "3 types of herbal tea combo", zh: "3 种草药茶套餐" },
            { vi: "1 buổi tư vấn online với bác sĩ/chuyên gia", en: "1 online consultation with a doctor/expert", zh: "1 次医生/专家在线咨询" },
            { vi: "Giảm 15% tất cả sản phẩm", en: "15% off all products", zh: "所有产品 15% 折扣" },
            { vi: "Ebook cẩm nang sức khỏe", en: "Health handbook ebook", zh: "健康手册电子书" },
            { vi: "Tích điểm khi mua hàng", en: "Earn points on purchases", zh: "购物累计积分" },
        ],
    ...
    },
    {
        ...
        price: 999000,
        description: {
            vi: "Dành cho hộ gia đình, kết hợp combo sản phẩm, tư vấn định kỳ và quyền lợi mua hàng.",
            en: "For families, combining product combos, periodic consultation, and shopping benefits.",
            zh: "适合家庭用户，结合产品组合、定期咨询和购物权益。",
        },
        benefits: [
            { vi: "Combo sản phẩm cho 4 người", en: "Product combo for 4 people", zh: "4 人产品套餐" },
            { vi: "3 buổi tư vấn online", en: "3 online consultations", zh: "3 次在线咨询" },
            { vi: "Giảm 20% tất cả sản phẩm", en: "20% off all products", zh: "所有产品 20% 折扣" },
            { vi: "Tích điểm x2", en: "Double points", zh: "双倍积分" },
            { vi: "Miễn phí vận chuyển cho đơn hàng đạt điều kiện", en: "Free shipping for eligible orders", zh: "符合条件订单免运费" },
            { vi: "Nội dung chăm sóc sức khỏe cho gia đình", en: "Family health care content", zh: "家庭健康护理内容" },
        ],
    ...
    },
    {
        ...
        price: 3000000,
        description: {
            vi: "Dành cho khách hàng cao cấp, tập trung vào tư vấn định kỳ, ưu đãi cao và chăm sóc cá nhân hóa.",
            en: "For premium customers with periodic consultation, high-value offers, and personalized care.",
            zh: "适合高端客户，重点提供定期咨询、高额优惠和个性化护理。",
        },
        benefits: [
            { vi: "Tư vấn định kỳ hằng tháng", en: "Monthly regular consultation", zh: "每月定期咨询" },
            { vi: "Giảm 30% tất cả sản phẩm", en: "30% off all products", zh: "所有产品 30% 折扣" },
            { vi: "Miễn phí vận chuyển trọn đời hoặc trong thời gian hiệu lực gói", en: "Free shipping for life or during package validity", zh: "终身或套餐有效期内免运费" },
            { vi: "Quà tặng VIP hằng quý", en: "Quarterly VIP gifts", zh: "季度 VIP 礼物" },
            { vi: "Tích điểm x3 khi mua hàng", en: "Triple points on purchases", zh: "购物三倍积分" },
            { vi: "Ưu tiên hỗ trợ chăm sóc khách hàng", en: "Priority customer care support", zh: "客户服务优先支持" },
            { vi: "Gợi ý sản phẩm và nội dung phù hợp theo nhu cầu", en: "Personalized product and content recommendations", zh: "根据需求推荐合适产品和内容" },
        ],
...
export const notifications: Notification[] = [
    {
        ...
        userId: 'user-1',
        title: {
            vi: 'Mã giảm giá GIAM20K đã sẵn sàng!',
            en: 'Voucher GIAM20K is ready!',
            zh: '折扣码 GIAM20K 已就绪！',
        },
        content: {
            vi: 'Nhận ngay giảm giá 20,000đ cho đơn hàng từ 150,000đ khi thanh toán.',
            en: 'Get 20,000 VND off for orders from 150,000 VND at checkout.',
            zh: '结账时订单满 150,000 VND 即可立减 20,000 VND。',
        },
        type: 'promotion',
        relatedId: 'GIAM20K',
        isRead: false,
    ...
    },
    {
        ...
        userId: 'user-1',
        title: {
            vi: 'Đặc quyền hạng thành viên mới',
            en: 'New Membership Privileges',
            zh: '新会员等级特权',
        },
        content: {
            vi: 'Nâng cấp chi tiêu tích điểm để nhận nhân hệ số điểm thưởng lên tới x2.0.',
            en: 'Upgrade spending to earn points with multipliers up to x2.0.',
            zh: '升级消费以获取积分，积分系数最高可翻 2.0 倍。',
        },
        type: 'system',
        isRead: false,
